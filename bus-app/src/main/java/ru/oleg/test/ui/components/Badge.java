...
import ru.oleg.test.ui.util.css.lumo.BadgeColor;
import ru.oleg.test.ui.util.css.lumo.BadgeShape;
import ru.oleg.test.ui.util.css.lumo.BadgeSize;

import java.util.StringJoiner;

import static ru.oleg.test.ui.util.css.lumo.BadgeShape.PILL;
