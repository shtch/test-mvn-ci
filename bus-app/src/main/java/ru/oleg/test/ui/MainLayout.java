...
import ru.oleg.test.ui.components.navigation.bar.TabBar;
import ru.oleg.test.ui.components.navigation.drawer.NaviDrawer;
import ru.oleg.test.ui.components.navigation.drawer.NaviItem;
import ru.oleg.test.ui.components.navigation.drawer.NaviMenu;
import ru.oleg.test.ui.util.LumoStyles;
import ru.oleg.test.ui.util.css.FlexDirection;
import ru.oleg.test.ui.util.css.Overflow;
import ru.oleg.test.ui.views.Accounts;
import ru.oleg.test.ui.views.Home;
import ru.oleg.test.ui.views.Payments;
import ru.oleg.test.ui.views.Statistics;
import ru.oleg.test.ui.views.personnel.Accountants;
import ru.oleg.test.ui.views.personnel.Managers;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

@HtmlImport("frontend://styles/shared-styles.html")
@Viewport("width=device-width, minimum-scale=1.0, initial-scale=1.0, user-scalable=yes")
@PWA(name = "bus-app", shortName = "bus-app", iconPath = "images/logo-18.png", backgroundColor = "#233348", themeColor = "#233348")
